...
import { getBookingSegments, deletePromo } from "@/features/promo/api/promos";
        ...
        <div className="p-6">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-md mb-10 h-[240px] w-full">
                ...
                <div className="absolute top-4 right-4 flex gap-2 z-10">
                    <button
                        onClick={() => {
                            console.log('Edit button clicked, navigating to:', `/dashboard/airline/promos/${promoId}/edit/step-1`);
                            router.push(`/dashboard/airline/promos/${promoId}/edit/step-1`);
                        }}
                    ...
                    <button
                        ...
                        className="bg-white/90 hover:bg-white text-red-600 rounded-full p-2 shadow-lg transition-all duration-200"
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-6 bg-gradient-to-t from-black/50 to-transparent text-white">
                    ...
                    <div className="flex flex-wrap items-center space-x-4 text-sm mb-2">
                        <p className="body-L-bold">{t("promo.target_audience")}</p>
            ...
            >
                <table className="w-full table-auto text-sm border border-border-default">
                    ...
                    <tr className="text-label-secondary body-M-semibold">
                        ...
                        <th className="px-4 py-3 border border-border-default whitespace-nowrap">{t("promo.target_audience")}</th>
                    ...
                    {segments.map((item, idx) => {
                        ...
                        return (
                            <tr key={idx} className="text-label-primary">
                                ...
                                <td className="px-4 py-3 whitespace-pre-line">{item.targetAudiences.map(aud => t(`promo.${aud}`)).join("\n")}</td>
                                ...
                                {canReadImsFees && (
                                    <td className="px-4 py-3 text-green-600 font-bold whitespace-nowrap">
                                        {sym} {Number(item.imsFees).toLocaleString()}
                                    </td>
                                )}
                            </tr>
                        );
