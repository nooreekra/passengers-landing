...
export default function EditPromoStep2() {
    ...
    useEffect(() => {
        if (data.targetAudiences && data.targetAudiences.length > 0) {
            ...
            setValue("items", [{ country: { value: "", label: "" }, cities: [], agencies: [] }]);
        }
    ...
    const onSubmit = async (form: FormValues) => {
        ...
        if (hasAllCountries) {
            await updateTargetAudiences(promoId as string, {
                countries: [],
                cities: [],
                businesses: [],
            });
        ...
        setData((prevData) => ({
            ...prevData,
            targetAudiences: form.items
        }));
        router.push(`/dashboard/airline/promos/${promoId}/edit/step-3`);
    };
