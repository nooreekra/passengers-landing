...
export default function EditPromoLayout({ children }: PropsWithChildren) {
    ...
    const steps = [
        ...
        { label: t("promo.step_target_countries", { defaultValue: "Target Countries" }), href: `/dashboard/partnership/promos/${promoId}/edit/step-2` },
        { label: t("promo.step_rewards_and_fees"), href: `/dashboard/partnership/promos/${promoId}/edit/step-3` },
    ];
