...
import { Award, Percent, Crown } from 'lucide-react'
      ...
      <section className="collect-miles-section" style={{ padding: '80px 20px 40px', minHeight: '100vh' }}>
        <div style={{ maxWidth: '1200px' }}>
          <h1 className="section-subtitle" style={{ 
            ...
            {t('landing.statusBenefits.statuses.platinum.name', 'Platinum')} Status
          </h1>
          ...
          <div style={{ maxWidth: '900px', marginLeft: 'auto', marginRight: 'auto', marginBottom: '20px' }}>
            ...
            <p className="section-description">
              {t('landing.statusBenefits.statuses.platinum.description', 'All you need is 65% of the trip cost to book your flight/hotel')}
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <ul style={{ listStyle: 'none', padding: 0 }}>
              <li className="section-description" style={{ marginBottom: '10px', paddingLeft: '30px', position: 'relative' }}>
                ...
                35% {t('landing.statusBenefits.discountLabel', 'DISCOUNT')} on flights and hotels
              </li>
              <li className="section-description" style={{ marginBottom: '10px', paddingLeft: '30px', position: 'relative' }}>
                <span style={{ position: 'absolute', left: 0, display: 'flex', alignItems: 'center' }}>
                  <Award size={24} />
                </span>
                Book with only 65% of trip cost in miles
              </li>
              <li className="section-description" style={{ marginBottom: '10px', paddingLeft: '30px', position: 'relative' }}>
                <span style={{ position: 'absolute', left: 0, display: 'flex', alignItems: 'center' }}>
                  <Crown size={24} />
                </span>
                Access to exclusive Platinum member benefits
              </li>
              <li className="section-description" style={{ paddingLeft: '30px', position: 'relative' }}>
                <span style={{ position: 'absolute', left: 0, display: 'flex', alignItems: 'center' }}>
                  <Award size={24} />
                </span>
                VIP customer support and highest priority booking
              </li>
            </ul>
          </div>
        </div>
