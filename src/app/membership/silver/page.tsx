      ...
      <section className="collect-miles-section" style={{ padding: '80px 20px 40px', minHeight: '100vh' }}>
        <div style={{ maxWidth: '1200px' }}>
          <h1 className="section-subtitle" style={{ 
            ...
            {t('landing.statusBenefits.statuses.silver.name', 'Silver')} Status
          </h1>
          ...
          <div style={{ maxWidth: '900px', marginLeft: 'auto', marginRight: 'auto', marginBottom: '20px' }}>
            ...
            <p className="section-description">
              {t('landing.statusBenefits.statuses.silver.description', 'All you need is 85% of the trip cost to book your flight/hotel')}
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <ul style={{ listStyle: 'none', padding: 0 }}>
              <li className="section-description" style={{ marginBottom: '10px', paddingLeft: '30px', position: 'relative' }}>
                ...
                15% {t('landing.statusBenefits.discountLabel', 'DISCOUNT')} on flights and hotels
              </li>
              <li className="section-description" style={{ marginBottom: '10px', paddingLeft: '30px', position: 'relative' }}>
                <span style={{ position: 'absolute', left: 0, display: 'flex', alignItems: 'center' }}>
                  <Award size={24} />
                </span>
                Book with only 85% of trip cost in miles
              </li>
              <li className="section-description" style={{ marginBottom: '10px', paddingLeft: '30px', position: 'relative' }}>
                <span style={{ position: 'absolute', left: 0, display: 'flex', alignItems: 'center' }}>
                  <Award size={24} />
                </span>
                Access to exclusive Silver member benefits
              </li>
